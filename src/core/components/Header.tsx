      ...
      <div className="flex items-center gap-6">
        ...
        <div className="relative w-56 sm:w-64">
          <input
            type="text"
            placeholder="Search..."
            className="w-full pl-4 pr-9 py-1.5 text-xs rounded-xl bg-[#141b2d] border border-[#2c3754] text-white placeholder-[#A0AEC0] focus:outline-none focus:border-[#00BCE1] focus:ring-1 focus:ring-[#00BCE1]/50 transition-all"
          />
